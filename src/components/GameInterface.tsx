...
export const GameInterface: React.FC<GameInterfaceProps> = ({ category }) => {
  ...
  return (
    <main className={cn(
      ...
      {/* HUD */}
      {/* HUD — Compact in landscape */}
      <div className="flex items-center justify-between px-4 py-3 landscape:py-2 z-10 shrink-0">
      ...
      {/* Main Word Card Area */}
      <div className="flex-1 flex items-center justify-center p-3 landscape:p-2 relative min-h-0 overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="w-full max-w-2xl h-full max-h-[55vh] landscape:max-h-full bg-white rounded-[2rem] flex items-center justify-center text-center p-4 landscape:p-6 shadow-2xl relative z-10"
          >
            <h2 className="text-3xl sm:text-4xl md:text-6xl landscape:text-4xl font-black tracking-tight uppercase break-words px-4 text-black">
              {currentWord}
            </h2>
          </motion.div>
        </AnimatePresence>
      ...
      {/* Footer Instructions — Hidden in landscape to maximize vertical space */}
      <div className="p-3 text-center text-slate-300 text-xs landscape:hidden shrink-0">
